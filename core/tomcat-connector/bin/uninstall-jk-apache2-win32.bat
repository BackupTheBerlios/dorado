...
REM This Shell Script resolves the connection of Tomcat 5.5 
REM with the Apache2 Webserver.
...
call %DORADO_INSTALLER_DIR%/ant/bin/ant.bat -Ddorado.apache.home="%APACHE_HOME%" -f %DORADO_INSTALLER_DIR%/conf/dorado-install.xml uninstall-jk-apache2-win32
...
call "%APACHE_HOME%\bin\Apache.exe" -k restart
